...
# Anwenden der Methoden durch feature_calculation.py und speichern der Ergebnisse.
all_df = calcFeature(comb_df)
all_df.to_csv('../result/52000000-53000000.csv')

# Erstellung der Eventlogs durch eveltlogGenerater.py und speichern der Ergebnisse.
